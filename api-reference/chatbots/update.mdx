...
api: "POST https://app-chatwize.com/api/v1/chatbot/{uuid}/update"
...
uuid = '<chatbot-uuid>'
url = f'https://app-chatwize.com/api/v1/chatbot/{uuid}/update'
headers = {
...
const url = `https://app-chatwize.com/api/v1/chatbot/${uuid}/update`;
const headers = {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer <token>'
};
