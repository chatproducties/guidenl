...
api: "GET https://app-chatwize.com/api/v1/session/{uuid}"
...
```bash Curl
curl --location --request GET 'https://app-chatwize.com/api/v1/session/{uuid}' \
...
uuid = '<session-uuid>'
url = f'https://app-chatwize.com/api/v1/session/{uuid}'
headers = {
...
const url = `https://app-chatwize.com/api/v1/session/${uuid}`;
const headers = {
