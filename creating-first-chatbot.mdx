...
description: "Maak je eerste AI-chatbot met Chatwize: start direct, kies een slimme sjabloon en train hem met je eigen data."
---
...
Laten we als voorbeeld de **Klantadviseur** nemen. Nadat je deze persona hebt geselecteerd, kies je de specialisatie van je AI-agent. In dit geval kiezen we **Customer Support**. Vervolgens geef je op welke organisatie de AI-agent vertegenwoordigt en wie de contactpersoon is voor escalaties.
