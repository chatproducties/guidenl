...
description: "Leer in Fijn Afstemmen van Agent Intents hoe je binnen Chatwize de juiste AI Agent koppelt aan gebruikersvragen voor maximale nauwkeurigheid."
---
...
<Frame>
  ![](/images/finetuning1.jpg)
</Frame>

Navigeer naar het tabblad **Intents**.

<Frame>
  ![](/images/finetuning2.jpg)
</Frame>
...
<Frame>
  ![](https://mintlify.s3.us-west-1.amazonaws.com/paladinmaxinc/images/fine-tuning-agent-intents-7.png)
</Frame>

Specificeer de intentie en voeg enkele voorbeeldvragen toe die gebruikers kunnen invoeren om deze intentie aan te geven.

<Frame>
  ![](https://mintlify.s3.us-west-1.amazonaws.com/paladinmaxinc/images/fine-tuning-agent-intents-8.png)
</Frame>
...
<Frame>
  ![](https://mintlify.s3.us-west-1.amazonaws.com/paladinmaxinc/images/fine-tuning-agent-intents-9.png)
</Frame>
...
<Frame>
  ![](https://mintlify.s3.us-west-1.amazonaws.com/paladinmaxinc/images/fine-tuning-agent-intents-10.png)
</Frame>
